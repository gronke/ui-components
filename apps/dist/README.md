...
This is the packaging entry for the generated web catalog.
It drives `uic_codegen_web`'s `dist` feature to emit what a browser project would `npm install`, rather than serving anything itself.
