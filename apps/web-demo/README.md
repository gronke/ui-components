...
`build.rs` bakes the frontend — the generated Lit components, the vendored modules, and the `<app-root>` composition (`ui_components_demo`) — and the binary serves it.
